...
export function localStudioContent(contacts: ContactData, prices?: PriceDocument['prices']) {
  ...
  return {
    ...
    questions: [
      { question: 'Де знаходиться студія?', answer: `Наша адреса: ${contacts.city}, ${contacts.address}. На карті нижче можна побудувати маршрут від свого місця перебування. Перед візитом узгодь час запису.` },
